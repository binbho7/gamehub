...
const nav = [{ label: "游戏", href: "/games" }, { label: "最新发布", href: "/games?sort=newest" }, { label: "即将上线", href: "/games?status=upcoming" }, { label: "平台", href: "/platforms/windows" }, { label: "类型", href: "/genres/action" }];
