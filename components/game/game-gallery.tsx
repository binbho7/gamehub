...
export function GameGallery({ images, title }: { images: string[]; title: string }) {
  ...
  if (images.length === 0) return <section><h2 className="text-2xl font-semibold">游戏截图</h2><p className="mt-6 rounded-xl border bg-card p-5 text-sm text-muted-foreground">暂无截图</p></section>;
